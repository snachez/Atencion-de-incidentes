...
namespace Atencion_de_incidentes.Controllers
{
    ...
    { 
        ModeloUnedMS db = new ModeloUnedMS();
        ...
        public async Task<ActionResult> Login(LoginViewModel model, string returnUrl)
        {
            ...
            var username = db.AspNetUsers.Where(x => x.Email ==model.Email).FirstOrDefault().UserName;
            ...
            switch (result)
            {
                ...
                default:
                    ModelState.AddModelError("", "Error! Contraseña o correo Electrónico invalido");
                    return View(model);
            }
        }
